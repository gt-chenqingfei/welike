...
public class InterestClassicsHeader extends ClassicsHeader {
    private int mRefreshCount;

    public InterestClassicsHeader(Context context) {
        super(context);
    }

    public InterestClassicsHeader(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public InterestClassicsHeader(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public InterestClassicsHeader(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {

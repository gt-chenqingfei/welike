 ...
 */
class FollowUserBtnCallbackImpl: IItemVisibleCallback<List<User>> {

    private lateinit var dataProvider: IDataProvider<List<User>>
    private lateinit var source: String
    private var hasHeader: Boolean = false

    override fun bindDataAndSource(dataProvider: IDataProvider<List<User>>, oldSource: String?) {

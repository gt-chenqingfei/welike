...
public class DPopupWindow extends PopupWindow {
    ...
    public DPopupWindow(Context context) {
        super(context);
    }

    public DPopupWindow(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public DPopupWindow(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public DPopupWindow(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public DPopupWindow(View contentView) {
        super(contentView);
    }

    public DPopupWindow(int width, int height) {
        super(width, height);
    }

    public DPopupWindow(View contentView, int width, int height) {
        super(contentView, width, height);
    }

    public DPopupWindow(View contentView, int width, int height, boolean focusable) {

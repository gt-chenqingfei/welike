...
public class UserFollowingView implements IUserFollowingContract.IUserFollowingView, ILoadMoreDelegate {
    ...
    public void initViews() {
        ...
        mEmptyView.showEmptyBtn(R.drawable.ic_common_empty,
                ResourceTool.getString(ResourceTool.ResourceFileEnum.USER, "user_following_page_empty_btn"),
                ResourceTool.getString(ResourceTool.ResourceFileEnum.USER, "user_following_page_empty"),
    ...
    @Override
    public void setPresenter(IUserFollowingContract.IUserFollowingPresenter iUserFollowingPresenter) {
        mPresenter = iUserFollowingPresenter;
    }

    @Override
    public void setAdapter(UserFollowingRecyclerAdapter mAdapter, ItemExposeManager callback) {

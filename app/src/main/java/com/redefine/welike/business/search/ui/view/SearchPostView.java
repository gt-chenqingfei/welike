...
public class SearchPostView implements ISearchPostContract.ISearchPostView, ILoadMoreDelegate {

    private RecyclerView mRecyclerView;
    private ISearchPostContract.ISearchPostPresenter mPresenter;
    ...
    public View createView(Context context, Bundle savedInstanceState) {
        View view = LayoutInflater.from(context).inflate(R.layout.search_post_layout, null);
        initViews(view);
        return view;
    }
...
//        mRecyclerView.addOnScrollListener(mVideoItemVisibilityCalculator);
    ...
    @Override
    public void setAdapter(SearchPostAdapter mAdapter) {
        mRecyclerView.setAdapter(mAdapter);
    }

    @Override
    public void setPresenter(ISearchPostContract.ISearchPostPresenter searchMixPostPresenter) {
        mPresenter = searchMixPostPresenter;
    }
    ...
    public void setRecyclerViewManager(ItemExposeManager manager) {
        ...
        manager.attach(mRecyclerView, (FeedRecyclerViewAdapter) mRecyclerView.getAdapter(), EventConstants.FEED_SOURCE_SEARCH_POSTS);
    }
}

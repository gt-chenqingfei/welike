...
public class CircleProgressView extends View {
    ...
    public CircleProgressView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        default_text_size = ScreenUtils.sp2px(context, 18);
        min_size = (int) ScreenUtils.dip2Px(context, 100);
        default_stroke_width = ScreenUtils.dip2Px(context, 10);
        default_inner_bottom_text_size = ScreenUtils.sp2px(context, 18);
    ...
    protected void initByAttributes(TypedArray attributes) {
        ...
        showText = attributes.getBoolean(R.styleable.CircleProgress_circle_show_text, true);
        ...
        finishedStrokeWidth = attributes.getDimension(R.styleable.CircleProgress_circle_finished_stroke_width, default_stroke_width);
        unfinishedStrokeWidth = attributes.getDimension(R.styleable.CircleProgress_circle_unfinished_stroke_width, default_stroke_width);

        if (showText) {
            if (attributes.getString(R.styleable.CircleProgress_circle_prefix_text) != null) {
                prefixText = attributes.getString(R.styleable.CircleProgress_circle_prefix_text);
            }
            if (attributes.getString(R.styleable.CircleProgress_circle_suffix_text) != null) {
                suffixText = attributes.getString(R.styleable.CircleProgress_circle_suffix_text);
            }
            if (attributes.getString(R.styleable.CircleProgress_circle_text) != null) {
                text = attributes.getString(R.styleable.CircleProgress_circle_text);
            }
            ...
            innerBottomTextSize = attributes.getDimension(R.styleable.CircleProgress_circle_inner_bottom_text_size, default_inner_bottom_text_size);
            innerBottomTextColor = attributes.getColor(R.styleable.CircleProgress_circle_inner_bottom_text_color, default_inner_bottom_text_color);
            innerBottomText = attributes.getString(R.styleable.CircleProgress_circle_inner_bottom_text);
        }
        ...
        startingDegree = attributes.getInt(R.styleable.CircleProgress_circle_circle_starting_degree, default_startingDegree);
        innerBackgroundColor = attributes.getColor(R.styleable.CircleProgress_circle_background_color, default_inner_background_color);
    }
    ...
    public void setcircle_progress(String percent){

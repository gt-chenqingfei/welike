 ...
 */
public class RegistSmsCodeFragment extends Fragment {
    public static final String SMS_FRAGMENT_TAG = "sms_fragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        registeredViewModel.reqSMSCode(StartEventManager.getInstance().getPhone(), StartEventManager.getInstance().getPhone_location());
    ...
    public void onResume() {
        super.onResume();
//        TrackerUtil.getPageTracker().setScreenName(TrackerConstant.PAGE_SMS_CODE);
...
//        thirdLoginLayout.setThirdClickEnable(false);
    ...
    public void initEvents() {
        mBack.setText(ResourceTool.getString(ResourceTool.ResourceFileEnum.REGISTER, "regist_change_to_voice"));
        String hint = ResourceTool.getString(ResourceTool.ResourceFileEnum.REGISTER, "regist_sms_code_hint");
        String mobile = StartEventManager.getInstance().getPhone();
        mSmsCodeHint.setText(String.format(hint, mobile));
        tv_resend.setText(ResourceTool.getString(ResourceTool.ResourceFileEnum.REGISTER, "regist_enter_code_resend"));
        et_sms_code.requestFocus();
        mVerifyIcon.setImageResource(R.drawable.verify_code_sms);
        ...
        if (countDownTimer == null) {
            countDownTimer = new CountDownTimer(total * 1000, TIME_STEP) {
                ...
                public void onTick(long millisUntilFinished) {
                    total--;
                    String resentEx = ResourceTool.getString(ResourceTool.ResourceFileEnum.REGISTER, "regist_otp_resent");
                    String text = String.format(resentEx, total);
                    tv_count.setText(highKeyword(text, ResourceTool.getString(ResourceTool.ResourceFileEnum.REGISTER, "regist_otp_resent_key")));
                }
...
//                registeredViewModel.tryThird(thirdLoginType);
            ...
            public void onLoginCancel(ThirdLoginType thirdLoginType) {
                String cancelText = ResourceTool.getString(ResourceTool.ResourceFileEnum.REGISTER, "canceled");
    ...
    public void setOnClick() {
        ...
        mBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                registeredViewModel.setStatus(StartConstant.START_STATE_LOGIN_VOICE_CODE);
                if (eventModel != null) {

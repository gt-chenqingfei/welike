 ...
 */
public class BlockFollowingUserViewModel extends AndroidViewModel implements UsersManager.UsersCallback {
    ...
    public BlockFollowingUserViewModel(@NonNull Application application) {
        super(application);
        mUserManager = new UsersManager();
        mUserManager.setDataSourceProvider(new FollowingUsersProvider());

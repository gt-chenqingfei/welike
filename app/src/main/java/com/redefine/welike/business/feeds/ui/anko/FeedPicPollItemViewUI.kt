...
//-----------------text view holder-------------------///
class FeedPicPollItemViewUI : AnkoComponent<ViewGroup> {
    override fun createView(ui: AnkoContext<ViewGroup>) = with(ui) {
        constraintLayout {
            ...
            feedBottomCheckbox().lparams(0, wrapContent) {
                topToBottom = R.id.vote_pic_feed_multi_grid_view
                startToStart = ConstraintLayout.LayoutParams.PARENT_ID
                endToEnd = ConstraintLayout.LayoutParams.PARENT_ID
            }
            ...
            textView {
                ...
                topToBottom = R.id.common_feed_bottom_cb
                startToStart = ConstraintLayout.LayoutParams.PARENT_ID
                endToEnd = ConstraintLayout.LayoutParams.PARENT_ID
            ...
            FeedItemADCardUI().lparams(0, wrapContent) {
                topToBottom = R.id.tv_right_text
                startToStart = ConstraintLayout.LayoutParams.PARENT_ID
                endToEnd = ConstraintLayout.LayoutParams.PARENT_ID
            }

...
public class TopicSearchSugRequest1 extends BaseRequest {
    ...
    public TopicSearchSugRequest1(String keyword, Context context) {
        super(BaseHttpReq.REQUEST_METHOD_GET, context);

        setHost("search/skip/topic/name", true);

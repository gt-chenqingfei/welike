 ...
 **/
public class ForwardFeedVoteTextViewHolder extends ForwardFeedTextViewHolder implements VoteTextAdapter.OnVoteTextItemCheckedListener {
    ...
    public ForwardFeedVoteTextViewHolder( View inflate, IFeedOperationListener mUserFollowListener, IVoteChoiceListener voteChoiceListener) {

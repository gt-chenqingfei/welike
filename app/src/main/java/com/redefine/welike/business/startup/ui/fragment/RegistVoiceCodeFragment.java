 ...
 */
public class RegistVoiceCodeFragment extends Fragment {
...
//        thirdLoginLayout.setThirdClickEnable(false);
    ...
    public void initEvents() {
        mBack.setText(ResourceTool.getString(ResourceTool.ResourceFileEnum.REGISTER, "regist_change_to_sms"));
        String hint = ResourceTool.getString(ResourceTool.ResourceFileEnum.REGISTER, "regist_voice_code_hint");

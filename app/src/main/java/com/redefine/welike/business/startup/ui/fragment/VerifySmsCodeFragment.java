 ...
 */
public class VerifySmsCodeFragment extends Fragment {
...
//        thirdLoginLayout.setThirdClickEnable(false);
    ...
    public void initEvents() {
        mBack.setText(ResourceTool.getString("regist_change_to_voice"));
        String hint = ResourceTool.getString("regist_sms_code_hint");

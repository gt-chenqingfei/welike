...
public class VotePicViewHolder extends TextFeedViewHolder implements VotePicAdapter.OnVoteItemCheckedListener {
    ...
    public VotePicViewHolder(View itemView, IFeedOperationListener listener, IVoteChoiceListener voteChoiceListener) {
    ...
    public void bindViews(RecyclerView.Adapter adapter, PostBase postBase) {
        ...
        // TODO: 2018/5/11
        if (postBase instanceof PostBase) {

...
public class FeedLatestPostsFragment extends Fragment implements ILoadMoreDelegate, OnClickRetryListener, OnPostButtonClickListener, ErrorView.IErrorViewClickListener, IBrowseClickListener {
    ...
    public static FeedLatestPostsFragment create(String interest) {
        Bundle bundle = new Bundle();
        bundle.putString("interest_id", interest);
        FeedLatestPostsFragment fragment = new FeedLatestPostsFragment();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mShown = TextUtils.equals(interestId, BrowseConstant.INTEREST_ALL);
    ...
    public void refresh() {
        ...
        mRecyclerView.scrollToPosition(0);
        if (baseDiscoveryViewModel != null) mDiscoveryViewModel.refresh(interestId, mAdapter.getFeedSource());
        else
            mRefreshLayout.autoRefresh();
    }

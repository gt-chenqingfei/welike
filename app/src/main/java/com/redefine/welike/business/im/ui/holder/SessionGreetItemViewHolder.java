...
public class SessionGreetItemViewHolder extends BaseSessionItemViewHolder<MessageSession> {
    ...
    public SessionGreetItemViewHolder(View itemView, IDeleteSessionCallback callback, OnSessionLongClickListener listener) {
        super(itemView);
        mCallback = callback;
    ...
    @Override
    public void bindViews(RecyclerView.Adapter adapter, final MessageSession imSession) {
        super.bindViews(adapter, imSession);

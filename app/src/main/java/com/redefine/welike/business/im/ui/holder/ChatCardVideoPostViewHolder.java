...
public class ChatCardVideoPostViewHolder extends BaseChatCardViewHolder {

    private final TextView mTitleView;

    public ChatCardVideoPostViewHolder(SESSION mSession, View inflate, OnChatCardClickListener listener) {

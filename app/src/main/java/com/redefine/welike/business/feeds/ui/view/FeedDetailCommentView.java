...
public class FeedDetailCommentView implements IFeedDetailCommentContract.IFeedDetailCommentView, ErrorView.IErrorViewClickListener {
    private RecyclerView mRecyclerView;
    private IFeedDetailCommentContract.IFeedDetailCommentPresenter mPresenter;
    private EmptyView mEmptyView;
    private ErrorView mErrorView;
    private LoadingView mLoadingView;

    public FeedDetailCommentView() {
    }

    @Override
    public void setPresenter(IFeedDetailCommentContract.IFeedDetailCommentPresenter presenter) {
    ...
    public View createView(Context context, Bundle savedInstanceState) {
        View view = LayoutInflater.from(context).inflate(R.layout.feed_detail_comment_fragment, null);
        mRecyclerView = view.findViewById(R.id.feed_detail_comment_recycler_view);
        ...
        mEmptyView.showEmptyText(ResourceTool.getString(ResourceTool.ResourceFileEnum.FEED, "feed_detail_no_comment"));
        mErrorView.setOnErrorViewClickListener(this);
        listener = new CommonListener<String>() {
            @Override
            public void onFinish(String value) {
                mPresenter.deleteComment(value);
            }
        ...
        CommentsManager.regDeleteListener(listener);
        return view;
    }
...
//                });
    ...
    @Override
    public void destroy() {
        CommentsManager.unregDeleteListener(listener);
    }

 ...
 * create by honglin
 */
@PageName("HomeRecommendFragmentPage")
public class HomeRecommendFragmentPage extends BaseLifecyclePage {
    ...
    public HomeRecommendFragmentPage(BaseLifecyclePageStackManager stackManager, PageConfig config, PageCache cache) {
...
//        recommendUserViewModel = ViewModelProviders.of(this).get(RecommendUserViewModel1.class);
    ...
    private void initViews(ViewGroup container) {
        mRootView = LayoutInflater.from(container.getContext()).inflate(R.layout.page_recommend_home_layout, null);
        ...
        tvFollowBtn.setText(ResourceTool.getString(ResourceTool.ResourceFileEnum.USER, "follow_all_select"));
    ...
    private void showLoadingDlg() {
        if (loadingDlg == null) loadingDlg = new LoadingDlg(getPageStackManager().getActivity());
        loadingDlg.dismiss();
        loadingDlg.show();
    }

...
public class BlockSearchUserAdapter extends LoadMoreFooterRecyclerAdapter<CommonTextHeadBean, User> {

    private final OnBlockUserOpCallback mCallback;
    private List<User> mUsers = new ArrayList<>();

    public BlockSearchUserAdapter(OnBlockUserOpCallback callback) {
        mCallback = callback;
    }

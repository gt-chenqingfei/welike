...
public class ClassicsHeader extends RelativeLayout implements RefreshHeader {
    public String REFRESH_HEADER_LOADING = ResourceTool.getString(ResourceTool.ResourceFileEnum.COMMON, "refresh_header_refreshing");
    public String REFRESH_HEADER_FINISH = ResourceTool.getString(ResourceTool.ResourceFileEnum.COMMON, "refresh_header_default_finish");
    public String REFRESH_HEADER_ERROR = ResourceTool.getString(ResourceTool.ResourceFileEnum.COMMON, "refresh_header_failed");
    ...
    protected void initView(Context context, AttributeSet attrs) {
        ...
        mTitleText.setText(ResourceTool.getString(ResourceTool.ResourceFileEnum.COMMON, "refresh_header_pulldown"));
        ...
        LayoutParams lpArrow = new LayoutParams(density.dip2px(15), density.dip2px(15));
        ...
        LayoutParams lpResult = new LayoutParams((ViewGroup.LayoutParams)lpArrow);
        lpResult.addRule(CENTER_VERTICAL);
        lpResult.addRule(LEFT_OF, android.R.id.widget_frame);
        lpResult.rightMargin = density.dip2px(5);
        mResultView = new ImageView(context);
        addView(mResultView, lpResult);

        if (isInEditMode()) {
            mArrowView.setVisibility(GONE);
            mTitleText.setText(ResourceTool.getString(ResourceTool.ResourceFileEnum.COMMON, "refresh_header_refreshing"));
        } else {
        ...
        if (ta.hasValue(R.styleable.ClassicsHeader_srlDrawableProgress)) {
            mDrawable = ta.getDrawable(R.styleable.ClassicsHeader_srlDrawableProgress);
            mProgressView.setImageDrawable(mDrawable);
        } else {
    ...
    public int onFinish(@NonNull RefreshLayout layout, boolean success) {
        ...
        if (success) {
            ...
            mTitleText.setText(ResourceTool.getString(ResourceTool.ResourceFileEnum.COMMON, "refresh_header_failed"));
        }
    ...
    public void onStateChanged(RefreshLayout refreshLayout, RefreshState oldState, RefreshState newState) {
        switch (newState) {
            ...
            case PullDownToRefresh:
                ...
                mProgressView.setImageDrawable(mDrawable == null ? mProgressDrawable :mDrawable);
            ...
            case ReleaseToRefresh:
                mTitleText.setText(ResourceTool.getString(ResourceTool.ResourceFileEnum.COMMON, "refresh_header_release"));

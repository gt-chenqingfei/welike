...
public final class SPUtil {
     ...
     * @return the single {@link SPUtil} instance
     */
    public static SPUtil getInstance(Context context, final int mode) {
    ...
    public static SPUtil getInstance(Context context, String spName, final int mode) {
        if (isSpace(spName)) spName = "welike_SP";
    ...
    private SPUtil(Context context, final String spName, final int mode) {
        Context applicationContext = context.getApplicationContext();
        sp = applicationContext.getSharedPreferences(spName, mode);
    }

...
public class Flow {
    ...
    /**
     * Add task to this flow with wave.
     *
     * @param task task
     * @return Flow
     */
    public Flow with(Task task) {
        if (task != null) {
            Wave wave = mWaveArray.get(waveSeq);
            if (wave == null) {
                wave = new Wave(waveSeq, ProcessUtils.myProcessName());
    ...
    /**
     * Add task to this flow after wave.
     *
     * @param task task
     * @return Flow
     */
    public Flow after(Task task) {
        if (task != null) {
            waveSeq++;
            Wave wave = mWaveArray.get(waveSeq);
            if (wave == null) {

...
public class Item implements Parcelable {
    ...
    public Item(long id, String filePath, String mimeType, long size, long duration, int width, int height) {
        this.id = id;
    ...
    public Item(Uri uri, String filePath, String mimeType, long size, long duration, int width, int height) {
        this.id = 0;
        this.filePath = filePath;
        this.mimeType = mimeType;
        this.width = width;
    ...
    public boolean isImage() {
        ...
        return mimeType.equals(MimeType.IMAGE.toString())

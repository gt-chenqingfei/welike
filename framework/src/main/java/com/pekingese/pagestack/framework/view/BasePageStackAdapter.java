 ...
 * a {@link BasePageStack}.  You will most likely want to use a more
 * specific implementation of this, such as
 * {@link com.pekingese.pagestack.framework.view.PageStackAdapter}
 * <p>
 * <p>When you implement a PagerAdapter, you must override the following methods
 * at minimum:</p>
 * <ul>
 * <li>{@link #instantiateItem(ViewGroup, int)}</li>
 * <li>{@link #destroyItem(ViewGroup, int, BasePage)}</li>
 * <li>{@link #getCount()}</li>
 * <li>{@link #isViewFromObject(View, BasePage)}</li>
 * </ul>
 * <p>
 ...
 * and/or {@link #destroyItem(ViewGroup, int, BasePage)} will follow, and the end
 ...
 * the keys passed to {@link #destroyItem(ViewGroup, int, BasePage) destroyItem}
 * should be removed. The method {@link #isViewFromObject(View, BasePage)} identifies
 ...
 * {@link #destroyItem(ViewGroup, int, BasePage)} implementation would remove the
 * View from the parent ViewGroup and {@link #isViewFromObject(View, BasePage)}
 ...
 * the method {@link #getItemPosition(BasePage)}.</p>
 */
public abstract class BasePageStackAdapter {
    ...
    /**
     * detach a page for the given position.  The adapter is responsible
     * for detaching the view from its container, although it only must ensure
     * this is done by the time it returns from {@link #finishUpdate(ViewGroup)}.
     *
     * @param container The containing View from which the page will be detached.
     * @param position  The page position to be detached.
     * @param object    The same object that was returned by
     */
    ...
    public void attachItem(ViewGroup container, int pos, BasePage object) {
        throw new UnsupportedOperationException("Required method destroyItem was not overridden");
    }
     ...
     */
    public abstract boolean isViewFromObject(View view, BasePage object);

...
public class KPSwitchConflictUtil {
    ...
    public static void attach(final View panelLayout,
        ...
        if (cn.dreamtobe.kpswitch.util.KPSwitchConflictUtil.isHandleByPlaceholder(activity)) {
            focusView.setOnTouchListener(new View.OnTouchListener() {
                @Override
                public boolean onTouch(View v, MotionEvent event) {
                    if (event.getAction() == MotionEvent.ACTION_UP) {
            ...
            public void onClick(View v) {
                ...
                if (panelLayout.getVisibility() == View.VISIBLE) {
                    ...
                    if (boundTriggerSubPanelView.getVisibility() == View.VISIBLE) {
                        ...
                        // to show keyboard.
                        cn.dreamtobe.kpswitch.util.KPSwitchConflictUtil.showKeyboard(panelLayout, focusView);
                        switchToPanel = false;
                    ...
                    // panel is gone.
                    // to show panel.
                    cn.dreamtobe.kpswitch.util.KPSwitchConflictUtil.showPanel(panelLayout);
                    switchToPanel = true;

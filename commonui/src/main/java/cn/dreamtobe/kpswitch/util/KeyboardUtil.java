    ...
    private static class KeyboardStatusListener implements ViewTreeObserver.OnGlobalLayoutListener {
        ...
        private void calculateKeyboardHeight(final int displayHeight) {
            ...
            if (previousDisplayHeight == 0) {
                ...
                panelHeightTarget.refreshHeight(cn.dreamtobe.kpswitch.util.KeyboardUtil.getValidPanelHeight(getContext()));
                return;
            }
            ...
            boolean changed = cn.dreamtobe.kpswitch.util.KeyboardUtil.saveKeyboardHeight(getContext(), keyboardHeight);
            if (changed) {
                final int validPanelHeight = cn.dreamtobe.kpswitch.util.KeyboardUtil.getValidPanelHeight(getContext());

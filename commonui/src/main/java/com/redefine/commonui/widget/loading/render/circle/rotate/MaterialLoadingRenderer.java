package com.redefine.commonui.widget.loading.render.circle.rotate;
...
public class MaterialLoadingRenderer extends LoadingRenderer {
    ...
    private void init(Context context) {
        mStrokeWidth = ScreenUtils.dip2Px(context, DEFAULT_STROKE_WIDTH);
    ...
    protected void setBounds(Rect bounds) {
        ...
        mMinSize = Math.min(bounds.width(), bounds.height());
    }
    ...
    protected void draw(Canvas canvas) {
        ...
        int dx = (mBounds.width() - mMinSize) / 2;
        int dy = (mBounds.height() - mMinSize) / 2;
        mTempBounds.inset(mStrokeInset + dx, mStrokeInset + dy);

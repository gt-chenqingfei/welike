...
public class LoadingDlg extends Dialog {
    ...
    private boolean defaultCancelable = false;

    public LoadingDlg(Activity activity, String loadingText) {
    ...
    public LoadingDlg(Activity activity, boolean cancelable) {
        super(activity, R.style.loading_theme);
        setOwnerActivity(activity);
        this.defaultCancelable = cancelable;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setCancelable(defaultCancelable);
